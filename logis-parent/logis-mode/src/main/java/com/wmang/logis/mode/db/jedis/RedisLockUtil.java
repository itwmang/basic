package com.wmang.logis.mode.db.jedis;
...
import com.wmang.logis.mode.utils.JedisUtil;
...
public class RedisLockUtil {
	 ...
	 * @throws Exception
	 */
	public static <T> T executeSynchOperate(MainOperator<T> operator, String lockCacheKey, long milliTimeout)
			throws Exception {
