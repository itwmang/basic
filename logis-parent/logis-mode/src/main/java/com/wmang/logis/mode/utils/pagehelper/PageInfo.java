...
public class PageInfo<T> implements Serializable{
	private static final long serialVersionUID = -3938197581478601543L;
	// 当前页
	...
	private void calcNavigatepageNums() {
		...
		if (pageCount <= navigatePages) {
			navigatepageNums = new int[pageCount];
	...
	public boolean isBFirstPage() {
		return isFirstPage;
	}

	public boolean isBLastPage() {
		return isLastPage;
	}
