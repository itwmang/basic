...
import com.wmang.mode.utils.date.DateLunar;
import com.wmang.mode.utils.date.DateStyle;
import com.wmang.mode.utils.date.DateWeek;
...
public class DateUtil {
	...
	public static XMLGregorianCalendar convertToXMLGregorianCalendar(Date date) {
        ...
        try {
        	...
        	logger.error("Date 转换 XMLGregorianCalendar 失败！date:" + date, e);
        }
        return gc;
    }
	/*XMLGregorianCalendar to Date*/
	public static Date convertToDate(XMLGregorianCalendar cal) throws Exception{
		if (ValueUtil.isEmpty(cal)) {
			return null;
		}
	...
	public static String format(Date obj, String hYyyyMmDdHhMmSs) {
